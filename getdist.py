...
train_label_dist=torch.zeros(153)
for i in train_label:
    train_label_dist[i]+=1
...
valid_label_dist=torch.zeros(153)
for i in valid_label:
    valid_label_dist[i]+=1
...
"""
train_label_dist = torch.load("/users/PAS1289/oiocha/OGB-NeurIPS-Team-Park/Analysis/mingi_train_label.pt")
valid_label_dist = torch.load("/users/PAS1289/oiocha/OGB-NeurIPS-Team-Park/Analysis/mingi_valid_label.pt")
