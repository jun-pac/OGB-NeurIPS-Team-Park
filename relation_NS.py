...
class MAG240M(LightningDataModule):
    ...
    def convert_batch_train(self, batch_size, n_id, adjs, initial_batch):
        ...
        y = self.y[initial_batch].to(torch.long)
...
class RGNN(LightningModule):
    ...
    def validation_epoch_end(self, outputs) -> None:
        ...
        if self.batch_idx>=100 and self.val_acc_sum/self.val_cnt>self.max_val_acc:
            ...
            np.save(f'/users/PAS1289/oiocha/OGB-NeurIPS-Team-Park/val_activation/relation-NS_p={args.label_disturb_p}_batch={args.batch_size}',self.val_res)
...
if __name__ == '__main__':
    ...
    path_log = NROOT+f'/relation-NS_p={args.label_disturb_p}_batch={args.batch_size}.txt'
    ...
    if not args.evaluate:
        ...
        trainer = Trainer(max_epochs=args.epochs,
                          ...
                          default_root_dir=f'logs/relation-NS_p={args.label_disturb_p}_batch={args.batch_size}',
