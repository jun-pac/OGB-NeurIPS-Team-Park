...
if __name__ == '__main__':
    ...
    # MAIN
    # python OGB-NeurIPS-Team-Park/bi_toggle.py --label_disturb_p=0.1 --batch_size=1024 --visit_check --ckpt=/users/PAS1289/oiocha/logs/bi-toggle_p=0.1_batch=1024/lightning_logs/version_13168996/checkpoints/epoch=15-step=17391.ckpt
